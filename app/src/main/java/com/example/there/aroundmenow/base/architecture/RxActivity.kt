...
abstract class RxActivity<State, VM, Presenter>(
    ...
    private fun initializeLayout() {
        ...
        when (initializer) {
            is LayoutInitializer.DataBindingLayoutInitializer<*> -> initializer.binding.setLifecycleOwner(this)
            is LayoutInitializer.DefaultLayoutInitializer -> initializer.initializeLayout()
        }
    }
