...
import com.example.there.lookaround.databinding.CameraObjectClickedDialogBinding
...
import com.example.there.lookaround.util.lifecycle.OrientationManagerComponent
import com.example.there.lookaround.visualizer.VisualizerState
import com.example.there.lookaround.visualizer.camera.CameraState.Constants.cameraRanges
import com.example.there.lookaround.visualizer.camera.view.*
...
class CameraFragment : RxFragment.Stateful.HostAware.WithLayout<CameraState, MainState, VisualizerState, CameraActions>(
    ...
    override val cameraView: com.example.there.lookaround.visualizer.camera.view.CameraView?
        get() = camera_view
