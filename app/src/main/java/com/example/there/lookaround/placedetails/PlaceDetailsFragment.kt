...
import com.example.there.lookaround.databinding.FragmentPlaceDetailsBinding
...
import com.example.there.lookaround.placedetails.info.AddPlaceToFavouritesEvent
import com.example.there.lookaround.placedetails.info.PlaceInfoFragment
import com.example.there.lookaround.placedetails.map.PlaceDetailsMapFragment
import com.example.there.lookaround.placedetails.photoslist.PhotosLoadingService
import com.example.there.lookaround.placedetails.photoslist.PhotosSliderAdapter
import com.example.there.lookaround.util.ext.*
import com.example.there.lookaround.util.lifecycle.EventBusComponent
import com.example.there.lookaround.util.view.viewpager.FragmentTitledViewPagerAdapter
